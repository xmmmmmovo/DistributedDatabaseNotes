...
#ifndef EMERALDDB_OSSSOCKET_HPP
#define EMERALDDB_OSSSOCKET_HPP
...
public:
    ...
    _ossSocket(const char *pHostname, unsigned int port,
               int timeout = 0);
    ...
    static int   getPort(const char *    pServiceName,
                         unsigned short &port);
};

typedef class _ossSocket ossSocket;

#endif // EMERALDDB_OSSSOCKET_HPP
